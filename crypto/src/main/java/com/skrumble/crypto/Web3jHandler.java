...
public class Web3jHandler {
        ...
        private static String encodeTransferData(String toAddress, BigInteger sum) {
            Function function = new Function(
                    ...
                    Arrays.<Type>asList(new Address(toAddress), new Uint256(sum)), new ArrayList<TypeReference<?>>());
        ...
        private static String encodeBalanceData(String toAddress) {
            Function function = new Function(
                    ...
                    Collections.<Type>singletonList(new Address(toAddress)), new ArrayList<TypeReference<?>>());
            return FunctionEncoder.encode(function);
        }
